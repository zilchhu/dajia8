...
namespace d
{
    ...
    public class ExcelBuilder
    {
        ...
        public static async Task BuildTable1()
        {
            ...
            var doc = SpreadsheetDocument.Create(@$"/home/work/zilchhu/dajia8/files/绩效表{yesterday}.xlsx", SpreadsheetDocumentType.Workbook);
        ...
        public static async Task BuildTable2()
        {
            ...
            var doc = SpreadsheetDocument.Create(@$"/home/work/zilchhu/dajia8/files/营推表{yesterday}.xlsx", SpreadsheetDocumentType.Workbook);
            var workbookPart = doc.AddWorkbookPart();
        ...
        public static async Task BuildTable3()
        {
            ...
            var doc = SpreadsheetDocument.Create(@$"/home/work/zilchhu/dajia8/files/新店表{yesterday}.xlsx", SpreadsheetDocumentType.Workbook);
            var workbookPart = doc.AddWorkbookPart();
